...
std::vector<long> vectorUmnoj(std::vector<long>, std::vector<long>);
std::bitset<6> bitsetUmnoj(std::bitset<6>, std::bitset<6>, int, int);
...
int main() {
	...
	RezVector = vectorUmnoj(firstVector, secondVector);
...
std::vector<long> vectorUmnoj(std::vector<long> firstVec, std::vector<long>SecondVec) {
	std::vector<long> vec;
	Tackt = 0;
	Tackt -= firstVec.size();
...
std::bitset<6> bitsetUmnoj(std::bitset<6> a, std::bitset<6> b, int pairNum, int tackt) {
...
void Conveer(long first, long second, std::vector<long>& rez, int PairNum, int tackt) {
	...
	mtx4.unlock();
	result = bitsetUmnoj(Nums[0], Nums[1], PairNum, tackt);
	mtx4.lock();
